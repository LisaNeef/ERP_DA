...
%---cut---Figure \ref{fig:ER} shows the difference in the mean square error (again in the zonal wind field), between experiment 1 (no assimilation) and experiment 2 (assimilating the angular momentum), at the same time snapshots as the previous figures. 
