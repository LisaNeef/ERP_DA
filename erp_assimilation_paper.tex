...
Kevin Raeder \altaffilmark{2}, and
...
\section{Methods}
\label{sec:methods}
This study relies on eight idealized data assimilation experiments, four using the Community Atmosphere Model (CAM) and four using the Whole Atmosphere Community Climate Model (WACCM), and all run within the Data Assimilation Research Testbed \citep[DART]{Anderson2009} from the National Center for Atmospheric Research. 
