...
\hl{In the first set of experiments}, observations of Earth rotation parameters are used as proxies of the atmospheric angular momentum (Section \ref{sec:obs}) to evaluate a set of simulations assimilating real meteorological observations in the Whole Atmosphere Community Climate Model (WACCM).
...
\subsection{Assimilation of AAM into DART-CAM}
