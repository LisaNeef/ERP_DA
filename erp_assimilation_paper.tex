...
Kevin Raeder \altaffilmark{2}, 
Nick Pedatella \altaffilmark{3}, and
Jeffrey Anderson \altaffilmark{2}}

\altaffiltext{1}{Ocean Circulation and Climate Dynamics - Marine Meteorology,
   GEOMAR Helmholtz Centre for Ocean Research Kiel, Kiel, Germany.}
\altaffiltext{2}{Institute for Mathematics Applied to Geosciences, 
National Center for Atmospheric Research, Boulder, Colorado, USA.}
\altaffiltext{3}{High Altitude Observatory, National Center for Atmospheric Research, Boulder, Colorado, USA}
...
\section{Methods}
\label{sec:methods}
This study relies on eight idealized data assimilation experiments, four using the low-top Community Atmosphere Model 5 (CAM5) and four using the high-top Whole Atmosphere Community Climate Model (WACCM), all within the Data Assimilation Research Testbed \citep[DART]{Anderson2009} from the National Center for Atmospheric Research (NCAR). 
...
The reader familiar with these subjects may skip directly to the description of the experiments in Section \ref{sec:expts}, or the results in Sections \ref{sec:obs_space}-\ref{sec:evaluation_variable}.
...
\input{methods_diagnostics.tex}

\subsection{Assimilation Experiments}
\label{sec:expts}
\input{methods_expts.tex}
...
This section evaluates whether an assimilation run can be improved by actually assimilating the Earth rotation data. 
