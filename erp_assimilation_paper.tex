...
In the first set of experiments (Section \ref{sec:assimilation_variable}), idealized angular momentum observations are assimilated into the Community Atmosphere Model (CAM), the low-top version of WACCM. 
In the second set of experiments (Section \ref{sec:evaluation_variable}), observations of Earth rotation parameters are used as proxies of the atmospheric angular momentum (Section \ref{sec:obs}) to evaluate a set of simulations assimilating real meteorological observations in the Whole Atmosphere Community Climate Model (WACCM).
...
The reader familiar with these subjects may skip directly to the description of the experiments and their results in Sections \ref{sec:evaluation_variable}-\ref{sec:assimilation_variable}.
