...
Having found that it is extremely difficult to assimilate Earth rotation observations effectively, we now ask whether Earth rotation variables may be useful as an independent variable for evaluation of data assimilation systems. 
In practice, it can be difficult to judge whether data assimilation has succeeded in bringing a model closer to the truth, which isn't known. 
...
Since the three atmospheric angular momentum components are easy to compute from the modeled wind and pressure fields, and observed in the form of three parameters that are freely available at daily resolution, updated continuously, and available since the 1960s (and at high accuracy since about 1980), they could be a useful set of observables for evaluating the accuracy of constrained simulations.   
