...
%  20 Aug 2013: simplify how we choose the common grid for experiments with different time resolution
%	-- use intersect.m
%   3 Sep 2013: force the 2nd experiment to have all the same settings as the first (diagnostic, variable, etc.)
%   3 Feb 2014: make the colorbar an externally-specified component
%--------------------------------------------------------------------------------------------------------------
...
%% make sure that the diagnostic, the variable, and the time/lat/lonranges are the same in each experiment
E2.diagn = E1.diagn;
E2.variable = E1.variable;
E2.latrange = E1.latrange;
E2.lonrange = E1.lonrange;
E2.dayf = E1.dayf;
E2.day0 = E1.day0;
