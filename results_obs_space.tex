Figure \ref{fig:fit_to_ERPs} compares the angular momentum of the ensembles in \NODA-\ERPRST~(similar to \ref{fig:evalvariable_aam}, and again omitting $\chi_1$ for simplicity). 
