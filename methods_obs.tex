...
Note that the axial terms [(\ref{eq:I3}) and (\ref{eq:h3})] weight all longitudes equally in their integrals, which means that mass anomalies usually cancel in the global integral, such that the wind term, $h_3$, dominates the axial angular momentum  \citep{barnesetal1983}.
%
...
%$\chi_1$ has much weaker subseasonal to annual variations because surface pressure variations cause corresponding displacements of the ocean surface, which even out the angular momentum changes \citep[the so-called ``inverted barometer'' effect, e.g.][]{salsteinrosen1989}.
%---cut-------
