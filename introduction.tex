...
While these studies found that reconciling an ocean model to observed Earth rotation variations leads to physically plausible adjustments to the model fields, the solutions found by the data assimilation in these simulations may not have been unique or necessarily closer to the true state of the ocean.  
